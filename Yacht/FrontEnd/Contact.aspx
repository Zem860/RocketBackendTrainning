<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Yacht.Contact" %>
...
<body>
    <div class="contain"> 
  <div class="sub"> <p><a href="Homepage.aspx">Home</a></p></div>
...
<!--遮罩-->
<div class="bannermasks"><img src="/Tayanahtml/html/tayana/html/images/contact.jpg" alt="&quot;&quot;" width="967" height="371" /></div>
<!--遮罩結束-->
...
<div class="banner">
<ul>
<li><img src="/Tayanahtml/html/tayana/html/images/newbanner.jpg" alt="Tayana Yachts" /></li>
</ul>
...
<cc1:RecaptchaWidget
    ID="RecaptchaWidget1"
    runat="server"
    RenderApiScript="true"
    PublicKey=""
    PrivateKey="" />
   <asp:Label ID="Label1" ForeColor="Red" Visible="false" runat="server" Text="Label"></asp:Label>
    ...
    <tr>
      <td class="from01td01">&nbsp;</td>
      <td class="f_right">
<asp:LinkButton ID="LinkButton1" runat="server" OnClick="checkRobot" >
    <img src="/Tayanahtml/html/tayana/html/images/buttom03.gif" alt="Submit" width="59" height="25" />
</asp:LinkButton>
