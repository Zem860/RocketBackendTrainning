                    ...
                    <div class="card my-5">
                        <div class="card-body">
                            <a href="#" class="d-flex justify-content-center">
                                <img src="/assets/images/fluffy.svg" alt="image" class="img-fluid w-25 h-25" />
                            </a>
                            <div class="row">
                            ...
                            <h5 class="my-4 d-flex justify-content-center">Register an account</h5>
                            ...
                            <div class="d-grid mt-4">
                                <asp:Button ID="Submit" CssClass="btn btn-secondary" runat="server" Text="Register" OnClick="addUser" />
                            </div>
                            <hr />
                            <h5 class="d-flex justify-content-center">Don't have an account?</h5>
                            <div class="d-grid mt-4">
                                <asp:HyperLink ID="HyperLink2" CssClass="btn btn-secondary" runat="server" NavigateUrl="Login.aspx">Go Login</asp:HyperLink>
                            </div>
                        </div>
                    </div>
                </div>
