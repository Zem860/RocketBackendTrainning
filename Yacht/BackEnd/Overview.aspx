...
<asp:Content ID="Content20" ContentPlaceHolderID="Overview" runat="server">
    ...
    <!-- 圖片區塊 -->
    <div class="card mb-4">
        <div class="card-header fw-bold">News Photos</div>
        <div class="card-body text-center">
            ...
            <div class="d-flex justify-content-center mt-2">
                <asp:Button ID="ReplacePhoto" runat="server" Visible="false" CssClass="btn btn-warning me-2" Text="Replace Img" OnClick="Replace" />
